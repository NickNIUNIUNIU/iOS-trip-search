...
+ (UIBezierPath *)circleWith:(CGRect)originalFrame{
...
+ (UIBezierPath *)ChatBubble:(CGRect)originalFrame andTriHight:(CGFloat)triH{
    ...
    [bezierPath addLineToPoint:CGPointMake((w - triH)/2, h)];
    [bezierPath addLineToPoint:CGPointMake(w/2, h + triH)];
    [bezierPath addLineToPoint:CGPointMake((w + triH)/2, h)];
...
+ (UIBezierPath *)couponsSepra:(CGRect)originalFrame andRadis:(CGFloat)radis{
