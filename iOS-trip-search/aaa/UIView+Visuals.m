...
-(void)setCircleWithWith:(CGFloat)radius{
    ...
    UIBezierPath *maskPath = [UIBezierPath circleWith:rect];
...
-(void)setChatBoubleWith:(CGFloat)triH{
    CGRect rect = self.bounds;
    UIBezierPath *maskPath = [UIBezierPath ChatBubble:rect andTriHight:triH];
    CAShapeLayer *maskLayer = [CAShapeLayer layer];
    maskLayer.frame = rect;
    maskLayer.path = maskPath.CGPath;
    self.layer.mask = maskLayer;
...
-(void)setCouponsSepraWithradius:(CGFloat)radius;{
    CGRect rect = self.bounds;
    UIBezierPath *maskPath = [UIBezierPath couponsSepra:rect andRadis:radius];
    CAShapeLayer *maskLayer = [CAShapeLayer layer];
    maskLayer.frame = rect;
    maskLayer.path = maskPath.CGPath;
    self.layer.mask = maskLayer;
